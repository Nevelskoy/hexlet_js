...
//////////////////////////////////////////////////////////////////////
	...
	//Например:
		...
		//добавляем сотрудников в базуы
		bd1["Ivanov"] = MyData(MyData::MALE, 30, "engeneer", 1500);
		bd1["Petrova"] = MyData(MyData::MALE, 30, "designer", 2500);
		bd1["Sidorov"] = MyData(MyData::MALE, 30, "scientist", 3500);
		//. . .
